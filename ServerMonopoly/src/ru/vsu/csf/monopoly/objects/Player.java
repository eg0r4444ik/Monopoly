...
import ru.vsu.csf.monopoly.objects.cells.Start;
...
public class Player {
    ...
    public Player(Color color, int currentPosition, int cash, PlayingField playingField, List<Company> myCompanies, int countOfDouble) {
        this.color = color;
